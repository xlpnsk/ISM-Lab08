...
@Database(entities = {PozycjaMagazynowa.class, HistoriaZmian.class}, version = BazaMagazynowa.WERSJA, exportSchema = false)
public abstract class BazaMagazynowa extends RoomDatabase {
    ...
    public abstract HistoriaZmianDAO historiaZmianDAO();
}
